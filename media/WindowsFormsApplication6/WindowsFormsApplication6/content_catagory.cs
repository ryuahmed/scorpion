...
namespace WindowsFormsApplication6
{
    public partial class homepage : Form
    {
        ...
        private void get_filter_result()
        {
            ...
            string movie = "";
            string tv = "";
            movie = "select poster,id from content join info_series  where type ='Movie' and content.id = info_series.c_id";
            ...
            if(result_search.country!="")
            {
                ...
                movie = movie + " and info_series.country = '" + result_search.country + "'";

            }
            if (result_search.lang != "")
            {
                tv = tv + " and info_series.language = '" + result_search.lang + "'";
                movie = movie + " and info_series.language = '" + result_search.lang + "'";
            ...
            if (result_search.betn)
            {
                ...
                movie = movie + " and release_date >= '" + result_search.from + "-01-01' and release_date <= '" + result_search.to + "-31-31'";
            }
            if (result_search.on_this)
            {
                tv = tv + " and season.release_date like '" + result_search.from + "%'";
                movie = movie + " and release_date like '" + result_search.from + "%'";

            }
            if (result_search.after)
            {
                tv = tv + " and season.release_date >= '" + result_search.from + "-01-01'";
                movie = movie + " and release_date >= '" + result_search.from + "-01-01'";
